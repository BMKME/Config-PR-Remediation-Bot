...
class NISTRules:
    ...
    def check_response_plan(self, parsed_config: Dict[str, Any]) -> List[Dict[str, Any]]:
        ...
        if not cloudtrail_found:
            violations.append({
                ...
                'resource_key': 'aws_cloudtrail',
                'description': 'No CloudTrail configuration found',
                'remediation': 'Configure CloudTrail for audit logging and incident response',
    ...
    def _has_admin_access(self, policy_document: Dict[str, Any]) -> bool:
        """Check if policy document grants administrative access"""
